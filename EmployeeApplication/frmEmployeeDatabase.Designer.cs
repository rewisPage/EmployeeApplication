namespace EmployeeApplication
{
    partial class frmEmployeeDatabase
    {
        ...
        private void InitializeComponent()
        {
            ...
            dataGridViewCellStyle4.ForeColor = Color.FromArgb(0, 122, 204);
            dataGridViewCellStyle4.Padding = new Padding(3);
            dataGridViewCellStyle4.SelectionBackColor = Color.FromArgb(45, 45, 48);
            dataGridViewCellStyle4.SelectionForeColor = Color.FromArgb(0, 122, 204);
            dataGridViewCellStyle4.WrapMode = DataGridViewTriState.True;
            dgvEmployeeList.ColumnHeadersDefaultCellStyle = dataGridViewCellStyle4;
            dgvEmployeeList.ColumnHeadersHeightSizeMode = DataGridViewColumnHeadersHeightSizeMode.AutoSize;
            dataGridViewCellStyle5.Alignment = DataGridViewContentAlignment.MiddleLeft;
            dataGridViewCellStyle5.BackColor = Color.FromArgb(69, 69, 69);
            dataGridViewCellStyle5.Font = new Font("Segoe UI", 12F);
            dataGridViewCellStyle5.ForeColor = Color.White;
            dataGridViewCellStyle5.Padding = new Padding(3);
            dataGridViewCellStyle5.SelectionBackColor = Color.FromArgb(75, 75, 79);
            dataGridViewCellStyle5.SelectionForeColor = SystemColors.HighlightText;
            dataGridViewCellStyle5.WrapMode = DataGridViewTriState.False;
            dgvEmployeeList.DefaultCellStyle = dataGridViewCellStyle5;
            ...
            dataGridViewCellStyle6.SelectionBackColor = Color.FromArgb(75, 75, 79);
            dataGridViewCellStyle6.SelectionForeColor = SystemColors.HighlightText;
            dataGridViewCellStyle6.WrapMode = DataGridViewTriState.True;
            dgvEmployeeList.RowHeadersDefaultCellStyle = dataGridViewCellStyle6;
